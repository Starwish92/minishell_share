...
static int	cd_home(char *path, t_info_env *env_head)
{
	int		exit_code;
	char	*home;
	char	*tmp_pwd;
...
static int	cd_tilde(t_info_env *env_head)
{
	int		exit_code;
	char	*home;
	char	*tmp_pwd;
...
static int	cd_tilde_path(char *path, t_info_env *env_head)
{
	int		exit_code;
	char	*home;
	char	*tmp_pwd;
...
static int	cd_path(char *path, t_info_env *env_head)
{
	int		exit_code;
	char	*tmp_pwd;
